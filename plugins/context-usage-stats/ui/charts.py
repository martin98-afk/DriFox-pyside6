...
from app.utils.fluent_shim import IconWidget, isDarkTheme
...
class _BarChartWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        painter.drawText(QRectF(margin_left, 4, chart_w, 22), Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, self._title)
    ...
    def paintEvent(self, event):
        ...
        for i, (_, value) in enumerate(self._data):
            ...
            if i == self._hovered_index:
                ...
                painter.setPen(QPen(colors["text_secondary"], 1, Qt.PenStyle.DashLine))
...
class _ProjectBarWidget(QWidget):
    ...
    def paintEvent(self, event):
        ...
        title_font = QFont(font_family, title_size, QFont.Bold)
        painter.setFont(title_font)
        painter.drawText(QRectF(margin_left, 2, chart_w, title_h), Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter, self._title)
